...
Schedule_t	slFaceTargetScared[] =
{
	{
		tlFaceTargetScared,
		HL_ARRAYSIZE ( tlFaceTargetScared ),
		bits_COND_HEAR_SOUND |
		bits_COND_NEW_ENEMY,
		bits_SOUND_DANGER,
		"FaceTargetScared"
...
Schedule_t	slScientistStartle[] =
{
	{ 
		tlScientistStartle,
		HL_ARRAYSIZE ( tlScientistStartle ), 
		bits_COND_NEW_ENEMY |
		bits_COND_SEE_ENEMY |
		bits_COND_SEE_HATE |
		bits_COND_SEE_FEAR |
