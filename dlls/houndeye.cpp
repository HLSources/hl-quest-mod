...
Schedule_t	slHoundWakeUrgent[] =
{
	{
		tlHoundWakeUrgent,
		HL_ARRAYSIZE ( tlHoundWakeUrgent ),
		0,
		0,
		"WakeUrgent"
	},
...
Schedule_t	slHoundSpecialAttack1[] =
{
	{ 
		...
		HL_ARRAYSIZE ( tlHoundSpecialAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slHoundHopRetreat[] =
{
	{ 
		tlHoundHopRetreat,
		HL_ARRAYSIZE ( tlHoundHopRetreat ), 
		0,
		0,
		"Hound Hop Retreat"
	},
...
Schedule_t	slHoundCombatFailPVS[] =
{
	{ 
		...
		HL_ARRAYSIZE ( tlHoundCombatFailPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
...
Schedule_t	slHoundCombatFailNoPVS[] =
{
	{ 
		...
		HL_ARRAYSIZE ( tlHoundCombatFailNoPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
